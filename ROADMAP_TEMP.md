...
# Roadmap: hello-world MVP & Beyond
...
|----------|--------------|-------------|--------|----------------------------|--------------|
| **Must-Have (MVP Core)** | [Feature 1] | [TBD: Core feature for hello-world. Why: Enables prototype VPS management by github hook.] | Not Started | 5 | None |
...
## How to Contribute
- Propose features via [GitHub Issues](https://github.com/NesoHQ/hello-world/issues/new?template=feature_request.md).
